# Attempt to provide a real impl of AMQP not to be confused wtih RabbitMQ ;)

require File.join(File.dirname(__FILE__), "helpers")
require "sensu/transport/amqp"
require "logger"

describe "Sensu::Transport::AMQP" do
  include Helpers

  before do
    @transport = Sensu::Transport::AMQP.new
